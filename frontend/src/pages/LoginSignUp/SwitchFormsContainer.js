...
const SignInPanel = styled(Panel)`
  pointer-events: ${(props) => (props.clicked ? "none" : "all")};
...
const SignInContent = styled(Content)`
  transform: ${(props) => (props.clicked ? "translateX(-800px)" : "translateX(0%)")};

  @media (max-width: 870px) {
    transform: ${(props) => (props.clicked ? "translateX(-300px)" : "translateX(0%)")};
  }
`;

const SignUpContent = styled(Content)`
  transform: ${(props) => (props.clicked ? "translateX(0px)" : "translateX(800px)")};
    ...
    <Panels clicked={isActive}>
      <SignInPanel clicked={isActive}>
        <SignInContent clicked={isActive}>
          ...
          <SwitchButton onClick={handleClick}>Sign in</SwitchButton>
        </SignInContent>
